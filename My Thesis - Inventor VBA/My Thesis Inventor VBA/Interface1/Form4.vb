...
Public Class Form4
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim D1 As Double, Ypsos1 As Double, D2 As Double, Ypsos2 As Double, YpsosTomhs As Double, Gwnia As Double, NumOfPoints As Integer
        Try
            ...
            Gwnia = Double.Parse(TextBox6.Text)
        ...
        If Not oErr Then
            ...
            If D2 > D1 Then
                k += 1
                oErr = True
                oErrStr = "ΕRROR " & k & ": Λανθασμένη Υποβολή Δεδομένων. H διάμετρος της κατακόρυφης κυλινδρικής επιφάνιας πρέπει να είναι μεγαλύτερη ή ίση της διαμέτρου της οριζόντιας κυλινδρικής επιφάνιας (d1 >= d2)." & vbNewLine & vbNewLine
                RichTextBox1.AppendText(oErrStr)
            End If
            ...
            Else
                ...
                If Ypsos1 <= YpsosTomhs + B_oliko Then
                    k += 1
                    oErr = True
                    oErrStr = "ΕRROR " & k & ": Λανθασμένη Υποβολή Δεδομένων. Σήμφωνα με τα δεδομένα σας, το ύψος του κατακόρυφου κυλίνδορου είναι μικρό και δεν επιτυγχάνται ολοκληρωμένη τομή. Θα πρέπει ή το ύψος (h1) να είναι μεγαλύτερο των " & Format(YpsosTomhs + B_oliko, "0.000") & " (mm)." & vbNewLine & vbNewLine
                    RichTextBox1.AppendText(oErrStr)
                End If
                ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                If Ypsos2 <= c Then
                    k += 1
                    oErr = True
                    oErrStr = "ΕRROR " & k & ": Λανθασμένη Υποβολή Δεδομένων. Δεν επιτυγχάνται ολοκληρωμένη τομή των δύο κυλινδρικών επιφανειών λόγο μικρού ύψους της υπό γωνία κυλινδρικής επιφάνειας. Σύμφωνα με τα δεδομένα σας θα πρέπει h2 > " & Format(c, "0.000") & " (mm)." & vbNewLine & vbNewLine
                    RichTextBox1.AppendText(oErrStr)
                End If
        ...
        If Not oErr Then
            ...
            '3D kataskeyh
            Model_41_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2, YpsosTomhs, Gwnia, partDoc, partComp, Rip_precision)


            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' TELOS 3D MONTELOU 21 ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''




            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' EIKONA 3D MONTELOU 21 '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' Ypologismos Min-Max Shmeiwn 
            Dim minX, maxX, mesoX, minY, maxY, mesoY As Double
            Ypologismos_Min_Max_41(myEdge1, D1, D2, xPoints, yPoints, NumOfPoints, peristrafike, Ypsos1, YpsosTomhs, minX, maxX, mesoX, minY, maxY, mesoY)
            'MsgBox("p1=( " & minX & ", " & mesoY & " )")
            'MsgBox("p2=( " & mesoX & ", " & maxY & " )")
            'MsgBox("p3=( " & maxX & ", " & mesoY & " )")
            'MsgBox("p4=( " & mesoX & ", " & minY & " )")

            ''''''''''''''''''' edw kanw ton peiragmeno ypologismo an xriazetai
            If D1 <> D2 Then
                Ypologismos_Edge41(myEdge1, NumOfPoints, peristrafike, YpsosTomhs, Ypsos1, minX, maxX, xPoints, yPoints)
                xPoints(0) = minX
                xPoints(NumOfPoints / 2) = maxX
                yPoints(NumOfPoints / 2) = mesoY
            End If
            ...
            For i = 0 To NumOfPoints - 1
                ...
                ''''' ta metafero kai sto (0,0) to kentro ths trypas      '''''''Afinw opos einai pros to parwn
                xPoints(i) = Format(xPoints(i) - Math.PI * D1 / 2, "0.00")
                yPoints(i) = Format(yPoints(i) - mesoY, "0.00")
            Next
            ...
            '''''' 3D Model
            Model_42_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2, YpsosTomhs, Gwnia, partDoc, partComp, Rip_precision)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''



            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' EIKONA 3D MONTELOU 22 '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            Eikona_3D(myApplication, oSavePath, folder, PictureBox5, tries)
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''



            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' FLAT PATTERN CODE AND ROTATE 22 ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            Dim peristrafike2 As Integer
            ''''Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
            SelectRotateCase22(Rip_precision, D2, D1, Ypsos2 - c, peristrafike2)
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            '''' Edw h listes ela den einai num - 1 giati exoume kai to teleytaio
            Dim xPoints22(NumOfPoints) As Double
            Dim yPoints22(NumOfPoints) As Double

            ''''''' Vasikos Ypologismos
            Ypologismos_Edge42(oEdges, NumOfPoints, peristrafike2, D2, Ypsos2 - c, xPoints22, yPoints22)

            ''''''''''''''''' Edw kanw ton peiragmeno ypologismo otan D1 <> D2
            If D1 <> D2 Then
                Ypolgogismos_42_Synolikos(oEdges, NumOfPoints, Ypsos2 - c, peristrafike2, xPoints22, yPoints22)
            End If


            '''''''''' Ypologismos MaxY_2
            Dim maxY_2 As Double
            If D1 = D2 Then
                maxY_2 = yPoints22(NumOfPoints / 4)
            Else
                MaxY_2_ypologismos(oEdges, peristrafike2, Ypsos2 - c, maxY_2)
            End If



            'Afou ypologisa swsta simeia twra kanw to rotate
            Dim oLength2 As Double
            Dim oWidth2 As Double
            efarmoghRotate22(partComp, fp, peristrafike2, oLength2, oWidth2)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''


            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''' SSSSOSSSS EDW LINW TO PROVLIMA 1
            If Format(xPoints22(0), "0.00") <> 0 Then

                ' diorthwsh orientation 
                fp.FlatPatternOrientations.ActiveFlatPatternOrientation.FlipAlignmentAxis = True


                Dim temp As Double
                'Edw diorthonw tin seira twn xPoints22 kai ta vazw anapoda
                For i = 0 To NumOfPoints / 2 - 1

                    temp = xPoints22(i)
                    xPoints22(i) = xPoints22(NumOfPoints - i)
                    xPoints22(NumOfPoints - i) = temp

                    '' perito gia ton yPoints22() afou einai simetriko alla ase to se sxolia na fainete
                    temp = yPoints22(i)
                    yPoints22(i) = yPoints22(NumOfPoints - i)
                    yPoints22(NumOfPoints - i) = temp
                Next
            ...
            '''''Tp palio provlima emfanizete gia d1<>d2  <<<<<<<<<---------------------- THELEI PSAKSIMO
            '''' Provlima tou 2*YpsosTomhs
            'If yPoints22(0) > 1.5 * YpsosTomhs Then
            '    'MsgBox("MPIKE GAMW")
            ...
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' TELOS 3D 21 ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            'Dim oPartDoc As PartDocument = myApplication.Documents.Open(oSavePath1 & "test_R1" & ".ipt", True)
            ...
            Dim V_D1, V_Ypsos1, V_D2, V_Ypsos2, V_YpsosTomhs, V_Gwnia As Double
            Dim V_minX, V_maxX, V_mesoX, V_minY, V_maxY, V_mesoY As Double
            ...
            If hole_Y > hole_X * 2.6 Then
                ...
                ''''''''' 3D kataskevh voithitikou
                Model_41_3D_Construction(myApplication, V_D1, V_Ypsos1, V_D2, V_Ypsos2, V_YpsosTomhs, V_Gwnia, partDoc, partComp, Rip_precision)
                ...
                '''''Kanw Rotate to Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
                'Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
                Rotate_Fp21(partComp, Rip_precision, V_D1, V_Ypsos1, fp, peristrafike, oLength, oWidth)
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' Ypologismos Min-Max Shmeiwn
                Ypologismos_Min_Max_41(myEdge1, V_D1, V_D2, xPointsValues, yPointsValues, NumOfPoints, peristrafike, V_Ypsos1, V_YpsosTomhs, V_minX, V_maxX, V_mesoX, V_minY, V_maxY, V_mesoY)
                'MsgBox("p1=( " & minX & ", " & mesoY & " )")
                'MsgBox("p2=( " & mesoX & ", " & maxY & " )")
                'MsgBox("p3=( " & maxX & ", " & mesoY & " )")
                'MsgBox("p4=( " & mesoX & ", " & minY & " )")
                ...
                ''''''''''''''''''' edw kanw ton peiragmeno ypologismo an xriazetai
                If D1 <> D2 Then
                    Ypologismos_Edge41(myEdge1, NumOfPoints, peristrafike, V_YpsosTomhs, V_Ypsos1, V_minX, V_maxX, xPointsValues, yPointsValues)
                    xPointsValues(0) = V_minX
                    xPointsValues(NumOfPoints / 2) = V_maxX
                    yPointsValues(NumOfPoints / 2) = V_mesoY
                End If
            ...
            Dim HoleY As Double = maxY - minY
            Dim x As Double = (Ypsos3D1 - HoleY) / 2
            Dim YpsosTomhsDiafforaApoMinY As Double = YpsosTomhs - minY
            Dim ypsosTomhs3D1 = x + YpsosTomhsDiafforaApoMinY

            Dim Adynato3D1 As Boolean = False
            If HoleY >= Ypsos3D1 * 0.99 Then
            ...
            Else
                ...
                Try
                    '3D kataskeyh
                    'Model_21_3D_Construction(myApplication, D1, Ypsos3D1, D2, Ypsos2, ypsosTomhs3D1, partDoc3D1, partComp3D1, Rip_precision3D1)
                    Model_41_3D_Construction(myApplication, D1, Ypsos3D1, D2, Ypsos2, ypsosTomhs3D1, Gwnia, partDoc3D1, partComp3D1, Rip_precision3D1)
            ...
            ''''''''''''''''''''''''''''''''''''''''''''''''''''' ARXH VOITHITIKOY_22 OTAN XRIAZETE '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            '''''''''''''''''''''''''''''''''' NEA PERIPTOSH GIA POIOTIKO STO 42 otan exei poly psilh kampili ''''''''''''''''''''''''''
            Dim Poiotiko42 As Boolean = False
            Dim YpsosKampilis As Double = maxY_2 * 10 - yPointsValues22(0)  ' To kanw * 10 (se mm) giati prin to eixa kanei /10
            ...
            If YpsosKampilis * 1.3 > New_maxY_2 And V2_Psilo And Not (V2_Konto) Then
                ...
                '''''' 3D Model
                Model_42_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2, YpsosTomhs, new_Gwnia, partDoc, partComp, Rip_precision)
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                ''''Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
                SelectRotateCase22(Rip_precision, D2, D1, Ypsos2 - new_c, peristrafike2)


                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' YPOLOGISMOS EDGES 42 
                ''Dim fpBody As SurfaceBody
                ''Dim oEdges As Edges 
                fpBody = fp.SurfaceBodies(1)
                oEdges = fpBody.Edges
                ...
                ''''''' Vasikos Ypologismos
                Ypologismos_Edge42(oEdges, NumOfPoints, peristrafike2, D2, Ypsos2 - new_c, xPointsValues22, yPointsValues22)

                ''''''''''''''''' Edw kanw ton peiragmeno ypologismo otan D1 <> D2
                If D1 <> D2 Then
                    Ypolgogismos_42_Synolikos(oEdges, NumOfPoints, Ypsos2 - new_c, peristrafike2, xPointsValues22, yPointsValues22)
                End If

                '''''''''' Ypologismos MaxY_2
                'Dim New As Double
                If D1 = D2 Then
                    New_maxY_2 = yPoints22(NumOfPoints / 4)
                Else
                    MaxY_2_ypologismos(oEdges, peristrafike2, Ypsos2 - new_c, New_maxY_2)
                End If
            ...
            If V2_Psilo Or V2_Konto Or Poiotiko42 Then
                ...
                '''''' 3D Model
                Model_42_3D_Construction(myApplication, D1, Ypsos1, D2, V_Ypsos22, YpsosTomhs, new_Gwnia, partDoc, partComp, Rip_precision)
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                ''''Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
                SelectRotateCase22(Rip_precision, D2, D1, V_Ypsos22 - new_c, peristrafike2)
                ...
                ''''''' Vasikos Ypologismos
                Ypologismos_Edge42(oEdges, NumOfPoints, peristrafike2, D2, V_Ypsos22 - new_c, xPointsValues22, yPointsValues22)

                ''''''''''''''''' Edw kanw ton peiragmeno ypologismo otan D1 <> D2
                If D1 <> D2 Then
                    Ypolgogismos_42_Synolikos(oEdges, NumOfPoints, V_Ypsos22 - new_c, peristrafike2, xPointsValues22, yPointsValues22)
                End If

                '''''''''' Ypologismos MaxY_2 telika gia to DWG
                'Dim DWG_maxY_2 As Double
                If D1 = D2 Then
                    DWG_maxY_2 = yPoints22(NumOfPoints / 4)
                Else
                    MaxY_2_ypologismos(oEdges, peristrafike2, Ypsos2 - new_c, DWG_maxY_2)
                End If
                ...
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''' SSSSOSSSS EDW LINW TO PROVLIMA 1
                If Format(xPointsValues22(0), "0.00") <> 0 Then
                    ...
                    For i = 0 To NumOfPoints / 2 - 1
                        ...
                        temp = xPointsValues22(i)
                        xPointsValues22(i) = xPointsValues22(NumOfPoints - i)
                        xPointsValues22(NumOfPoints - i) = temp

                        '' perito gia ton yPoints22() afou einai simetriko alla ase to se sxolia na fainete
                        temp = yPointsValues22(i)
                        yPointsValues22(i) = yPointsValues22(NumOfPoints - i)
                        yPointsValues22(NumOfPoints - i) = temp
                    Next

                End If

                '''''To palio provlima emfanizete gia d1<>d2  <<<<<<<<<---------------------- THELEI PSAKSIMO
                '''' Provlima tou 2*YpsosTomhs
                'If yPointsValues22(0) > 1.5 * YpsosTomhs Then
                '    'MsgBox("MPIKE GAMW")
                '    For k = 0 To NumOfPoints - 1
                '        yPointsValues22(k) -= YpsosTomhs
                '    Next
                'End If
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            Dim diafora As Double = maxY_2 * 10 - MaxY_2_3D   ' to kanw *10 gia na erthei kai ayto se xiliosta
            Dim Ypsos2_3D2 As Double = Ypsos2 - diafora

            Dim Adynato3D2 As Boolean = False

            If Not (Ypsos2_3D2 * 0.97 > c) Then
            ...
            Else
                ...
                Try
                    '3D kataskeyh
                    Model_42_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2_3D2, YpsosTomhs, Gwnia, partDoc3D2, partComp3D2, Rip_precision3D2)
            ...
            If NumOfPoints <= maxSeires Then
                ...
                If Not (poiotiko1) Then
                    ...
                    holeYpsos = maxY - minY
                Else
                    holeMikos = V_maxX - V_minX
                    holeYpsos = V_maxY - V_minY
                End If
                ...
                DWG_41(oSavePath1, myApplication, oSheet, D1, D2, Ypsos1, NumOfPoints, ViewScale1, minY, maxY, mesoY, poiotiko1, V_Ypsos1, V_D1, V_minY, V_maxY, V_mesoY, Adynato3D1, xPointsValues, yPointsValues, oLength, oWidth, maxSeires, xPoints, yPoints)


                '''''''''''''''''''''''''''''''''''''''''' ta panta gia ton orizontio
                DWG_42(oSavePath1, myApplication, V2_Konto, V2_Psilo, Poiotiko42, Adynato3D2, DWG_maxY_2, oSheet, oLength2, oWidth2, NumOfPoints, D1, D2, Gwnia, xPointsValues22, yPointsValues22, maxSeires, xPoints22, yPoints22)
                ...
                Ypomnima4(xPos, ViewScale1, poiotiko1, Poiotiko42, ViewScale2, Default_Micro_Path, oTG, oSketchYpomnima)
                ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                Dim Defaul_Pic1_Path As String = defPath & "\Capture4.png"
                '''''Dim LogoFilename1 As String = "C:\Users\antma\Desktop\Case 1\Interface1\picture1.png"
                Dim oSketchImage1 As SketchImage
                oSketchImage1 = oSketchYpomnima.SketchImages.Add(Defaul_Pic1_Path, oTG.CreatePoint2d(19 - 5.8 - 0.15, 27.7 - 0.15), False) 'to 6.5 = oSketchImage1.Width 
                '''''set image size in cm
                oSketchImage1.Height = 4
                oSketchImage1.Width = 5.8
                ...
                oTextBox = oSketchYpomnima.TextBoxes.AddFitted(oTG.CreatePoint2d(xText, yText - 2), sTextDedomena)
                oTextBox.VerticalJustification = VerticalTextAlignmentEnum.kAlignTextUpper
                oTextBox.HorizontalJustification = HorizontalTextAlignmentEnum.kAlignTextRight
                oTextBox.FormattedText = "<StyleOverride FontSize = '" & 0.25 & "'>" & sTextDedomena & "</StyleOverride>"
