...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim D1 As Double, Ypsos1 As Double, D2 As Double, Ypsos2 As Double, YpsosTomhs As Double, NumOfPoints As Integer
        Try
            ...
            NumOfPoints = Double.Parse(TextBox6.Text)
        ...
        If Not oErr Then
            ...
            If Ypsos2 <= D1 / 2 Then
                k += 1
                oErr = True
                oErrStr = "ΕRROR " & k & ": Λανθασμένη Υποβολή Δεδομένων. Το ύψος της οριζόντιας κυλινδρικής επιφάνιας πρέπει να είναι μεγαλύτερο του μισού της διαμέτρου της κατακόρυφης κυλινδρικής επιφάνιας (h2 > d1/2)." & vbNewLine & vbNewLine
                RichTextBox1.AppendText(oErrStr)
            End If
        ...
        If Not oErr Then
            ...
            '3D kataskeyh
            Model_21_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2, YpsosTomhs, partDoc, partComp, Rip_precision)
            ...
            '''''' 3D Model
            Model_22_3D_Construction(myApplication, D1, Ypsos1, D2, Ypsos2, YpsosTomhs, partDoc, partComp, Rip_precision)
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            ''''Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
            SelectRotateCase22(Rip_precision, D2, D1, Ypsos2 - D1 / 2, peristrafike2)
            ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            Ypologismos_Edge22(oEdges, NumOfPoints, peristrafike2, D2, Ypsos2 - D1 / 2, xPoints22, yPoints22)
            ...
            Model_21_3D_Construction(myApplication, D1, V_Ypsos1, D2, Ypsos2, V_YpsosTomhs, partDoc, partComp, Rip_precision)
            ...
            Dim maxYpsos2 As Double = yPoints22(NumOfPoints / 4) / 10
            ...
            If V2_Psilo Or V2_Konto Then
                ...
                '''''''3D kataskeyh me tis kainouries parametrous
                Model_22_3D_Construction(myApplication, D1, Ypsos1, D2, V_Ypsos2, YpsosTomhs, partDoc, partComp, Rip_precision)
                ...
                ''''Kanw Rotate To Fp an xriazete kai epistrefw ta oLength, oWidth kai to an telika peristrafike
                SelectRotateCase22(Rip_precision, D2, D1, V_Ypsos2 - D1 / 2, peristrafike2)
                ...
                Ypologismos_Edge22(oEdges, NumOfPoints, peristrafike2, D2, V_Ypsos2 - D1 / 2, xPointsValues22, yPointsValues22)
                '                                                           '''''' Telos YPOLOGISMOY exw parei ta xPointsValues, yPointsValues gia to DWG
            ...
            If NumOfPoints <= maxSeires Then
                ...
                DWG_21(oSavePath1, myApplication, oSheet, D1, D2, Ypsos1, NumOfPoints, ViewScale1, xPointsValues, yPointsValues, oLength, oWidth, maxSeires, xPoints, yPoints)


                '''''''''''''''''''''''''''''''''''''''''' ta panta gia ton orizontio
                DWG_22(oSavePath1, myApplication, V2_Konto, V2_Psilo, oSheet, oLength2, oWidth2, NumOfPoints, D1, D2, xPointsValues22, yPointsValues22, maxSeires, xPoints22, yPoints22)
                ...
                Ypomnima2(xPos, ViewScale1, ViewScale2, Default_Micro_Path, oTG, oSketchYpomnima)
                '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                Dim Defaul_Pic1_Path As String = defPath & "\Capture2.png"
